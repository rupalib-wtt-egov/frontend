          ...
          >
            ...
            <Grid container>
              <Grid xs={6} className={classes.subtext}>
                {item && item.wfState && item.wfState === "SEND_TO_CITIZEN" ? <Typography className={classes.body2}>WFState : {item.wfState}</Typography> : null }
                {item && item.wfState && item.wfState === "SEND_TO_CITIZEN" ? <Typography className={classes.body2}>CreatedBy: {item.createdBy}</Typography> : null }             
